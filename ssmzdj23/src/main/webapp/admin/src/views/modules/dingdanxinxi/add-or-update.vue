      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="小说编号" prop="xiaoshuobianhao">
          <el-input v-model="ruleForm.xiaoshuobianhao" 
              placeholder="小说编号" clearable  :readonly="ro.xiaoshuobianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="小说编号" prop="xiaoshuobianhao">
              <el-input v-model="ruleForm.xiaoshuobianhao" 
          ...
          <el-form-item class="input" label="小说名称" prop="xiaoshuomingcheng">
              <el-input v-model="ruleForm.xiaoshuomingcheng" 
                placeholder="小说名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="小说分类" prop="xiaoshuofenlei">
          <el-input v-model="ruleForm.xiaoshuofenlei" 
              placeholder="小说分类" clearable  :readonly="ro.xiaoshuofenlei"></el-input>
        </el-form-item>
        <div v-else>
